    ...
    setInputs() {
        return (
            <section className="inputs">
                ...
                <h1>Skills</h1>
                <SkillsInput onInputChange={this.handleChange} removeData={this.removeData} />
                <h1>Languages</h1>
                <LanguagesInput onInputChange={this.handleChange} removeData={this.removeData} />
                <h1>Projects</h1>
                <ProjectsInput onInputChange={this.handleChange} removeData={this.removeData} />
                <h1>Work experience</h1>
                <WorkInput onInputChange={this.handleChange} removeData={this.removeData} />
                <h1>Education</h1>
                <EducationInput onInputChange={this.handleChange} removeData={this.removeData} />
            </section>
        );
    }
